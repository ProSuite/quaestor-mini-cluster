...
# 
# Usage:
# DiscoverServices.ps1 HOSTNAME:Port ServiceName {PEM file with certificate authority}
#
# Example (insecure):
# DiscoverServices.ps1 localhost:5150 QualityVerificationGrpc
#
# Example (using TLS):
# DiscoverServices.ps1 MY_MACHINE.domain.com:5150 QualityVerificationGrpc "C:\Temp\root_ca.cer"
...
grpcurl.exe -d $serviceNameJson $tlsArg $cacert_file -import-path ..\src\Quaestor.ServiceDiscovery -proto service_discovery.proto $Address Quaestor.ServiceDiscovery.ServiceDiscoveryGrpc/DiscoverServices
