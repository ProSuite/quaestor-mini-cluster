...
grpcurl.exe -d $serviceNameJson -plaintext -import-path ..\src\Quaestor.ServiceDiscovery -proto service_discovery.proto $Address Quaestor.ServiceDiscovery.ServiceDiscoveryGrpc/DiscoverTopServices
